...
export default function AdminPage() {
  ...
  function publish(event: FormEvent<HTMLFormElement>) {
    ...
    setEvents((current) => [{ id: Date.now(), title, date: new Date(`${date}T12:00:00`).toLocaleDateString("es-AR", { day: "2-digit", month: "short", year: "numeric" }).toUpperCase(), status: "Publicado", image: "https://images.unsplash.com/photo-1506157786151-b8491531f063?auto=format&fit=crop&w=240&q=80" }, ...current]);
    setTitle(""); setDate(""); setDescription(""); setNotice("Evento publicado en la cartelera demo.");
  }
